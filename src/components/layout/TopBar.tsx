...
export function TopBar({
  ...
  return (
    <header className="glass-chrome sticky top-0 z-30 flex h-14 items-center gap-4 border-b border-cyan-400/15 px-4 lg:px-6">
      ...
      <div className="flex items-center gap-1">
        ...
        <NotificationsBell initialCount={notificationCount} />
      </div>
    </header>
  );
}
